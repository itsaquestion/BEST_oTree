...
class M7_Page(Page):
    form_model = 'player'
    form_fields = ['mm2f13', 'mm2f12', 'mm2f11', 'mm2f10', 'mm2f09', 'mm2f08', 'mm2f07', 'mm2f06', 'mm2f05', 'mm2f04',
                   'mm2f03', 'mm2f02', 'mm2f01']
...
class M9_Page(Page):
    form_model = 'player'
    form_fields = ['mm2f39', 'mm2f38', 'mm2f37', 'mm2f36', 'mm2f35', 'mm2f34', 'mm2f33', 'mm2f32', 'mm2f31', 'mm2f30',
                   'mm2f29', 'mm2f28', 'mm2f27']
...
class M11_Page(Page):
    form_model = 'player'
    form_fields = ['mm2f65', 'mm2f64', 'mm2f63', 'mm2f62', 'mm2f61', 'mm2f60', 'mm2f59', 'mm2f58', 'mm2f57', 'mm2f56',
                   'mm2f55', 'mm2f54', 'mm2f53']
...
class Results(Page):
    def vars_for_template(self):
        return {
            'final_pay': (50 - self.player.payoff.to_real_world_currency(self.session)),
...
class Survey(Page):
    ...
    def before_next_page(self):
        p = self.player
        m2 = ['A: 50%可能损失230代币，也有50%的可能损失170代币；  B：100%损失173.0代币', 'A: 50%可能损失230代币，也有50%的可能损失170代币；  B：100%损失176.0代币',
