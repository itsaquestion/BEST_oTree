...
class Player(BasePlayer):
    ...
    sur_birth_year = models.IntegerField(verbose_name="1.你出生的年份是(请填后面2位数)")
    ...
    sur_nation = models.StringField(verbose_name="8.你的民族是")
    ...
    sur_big_brother = models.IntegerField(verbose_name="13.你有几个亲哥哥（没有请填0）")
    sur_little_brother = models.IntegerField(verbose_name="你有几个亲弟弟（没有请填0）")
    sur_big_sister = models.IntegerField(verbose_name="你有几个亲姐姐（没有请填0）")
    sur_little_sister = models.IntegerField(verbose_name="你有几个亲妹妹（没有请填0）")
    sur_mother = models.StringField(verbose_name="14.母亲的最高学历")
    sur_father = models.StringField(verbose_name="父亲的最高学历")
    ...
    sur_income = models.StringField(
        verbose_name="16.你的家庭年收入大概是什么范围",
    ...
    sur_left_behind = models.StringField(verbose_name="17.是否11岁之前有过留守经历（留守：父亲或者母亲外出务工连续三个月以上，由父、母单方或其他亲属监护接受义务教育）",
                                        choices=['是', '否'],
                                        widget=widgets.RadioSelectHorizontal
                                        )
